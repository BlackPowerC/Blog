<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            <li><a class="active" href="home.php"><i class="glyphicon glyphicon-home"></i> Accueil</a></li>
            <li><a href="userpanel.php"><i class="glyphicon glyphicon-user"></i> Espace Utilisateur</a></li>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li><a href="connexion.php?msg=good_action"><i class="glyphicon glyphicon-log-in"></i> Connexion</a></li>
